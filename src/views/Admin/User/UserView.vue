        ...
        <v-card>
            ...
            <tbody>
              <tr v-for="i in users" :key="i">
                ...
                <td class="text-center">
                  <v-btn density="compact" variant="text"><i @click="updateUserById(i.id)"
                      class="fa-regular fa-pen-to-square mr-4"></i><i @click="{ isDialogDelete = true; idDelete = i.id }"
          ...
          <v-row class="ma-2">
            ...
            <v-col cols="4" class="text-right">
              <v-pagination v-model="page" active-color="#red" variant="text" density="compact"
