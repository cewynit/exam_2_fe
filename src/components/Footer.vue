  ...
  <div>
    <v-row>
        <v-col cols="12" md="4" sm="12" lg="4">
            <v-card variant="tonal" height="156px" with="361px">
                <v-card-title class="text-center mt-4">
                  <v-img src="../assets/img/f1.png" height="44px" with="44px" class="ma-2"></v-img>
                </v-card-title>
        ...
        <v-col cols="12" md="4" sm="12" lg="4">
            <v-card variant="tonal" height="156px" with="361px">
                <v-card-title class="text-center mt-4">
                  <v-img src="../assets/img/f2.png" height="44px" with="44px" class="ma-2"></v-img>
                </v-card-title>
        ...
        <v-col cols="12" md="4" sm="12" lg="4">
            <v-card variant="tonal" height="156px" with="361px" >
                <v-card-title class="text-center mt-4">
                  <v-img src="../assets/img/f3.png" height="44px" with="44px" class="ma-2"></v-img>
                </v-card-title>
